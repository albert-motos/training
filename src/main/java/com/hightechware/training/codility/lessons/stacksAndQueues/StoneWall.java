 ...
 * Write a function:
 * <p>
 * class Solution { public int solution(int[] H); } that, given a zero-indexed array H of N positive integers specifying
 * the height of the wall, returns the minimum number of blocks needed to build it.
 * <p>
 * For example, given array H containing N = 9 integers:
 * <p>
 * H[0] = 8    H[1] = 8    H[2] = 5 H[3] = 7    H[4] = 9    H[5] = 8 H[6] = 7    H[7] = 4    H[8] = 8 the function
 ...
 * Assume that:
 * <p>
 * N is an integer within the range [1..100,000]; each element of array H is an integer within the range
 * [1..1,000,000,000]. Complexity:
 * <p>
 * expected worst-case time complexity is O(N); expected worst-case space complexity is O(N), beyond input storage (not
 * counting the storage required for input arguments). Elements of input arrays can be modified. Created by albert-motos
 * on 17/07/2017.
 */
